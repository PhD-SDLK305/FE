...
export function Register() {
  ...
  return (
    <Card className='w-full max-w-md border shadow-2xl'>
      <AuthHeader handleNavigate={handleNavigate} currentPage={'Sign Up'} navigateTo={'Sign In'} desciption={'Enter your email below to register to your account'} />
      <CardContent>
        <form>
      ...
      <AuthFooter handleClick={handleSignUp} type={'Sign Up'} />
    </Card>
  )
}
